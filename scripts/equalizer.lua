...
local key_toggle_bindings = nil  -- enable/disable equalizer key bindings
local key_toggle_equalizer = nil  -- enable/disable equalizer
local key_reset_equalizer = nil
local bands = {
